...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    run!(y2016, d06, "Signals and Noise", selection);
    run!(y2016, d07, "Internet Protocol Version 7", selection);
    run!(y2016, d08, "Two-Factor Authentication", selection);
    run!(y2016, d09, "Explosives in Cyberspace", selection);
    run!(y2016, d10, "Balance Bots", selection);
