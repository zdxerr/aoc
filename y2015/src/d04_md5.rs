...
*/
fn round_one_operations(mut a: u32, mut b: u32, mut c: u32, mut d: u32, x: &Vec<u32>) -> [u32; 4] {
    macro_rules! round1 {
...
*/
fn round_two_operations(mut a: u32, mut b: u32, mut c: u32, mut d: u32, x: &Vec<u32>) -> [u32; 4] {
    macro_rules! round2 {
        ( $a:ident, $b:ident, $c:ident, $d:ident, $k:expr, $s:expr, $i:expr) => {
            $a = $b.wrapping_add(
...
*/
fn round_four_operations(mut a: u32, mut b: u32, mut c: u32, mut d: u32, x: &Vec<u32>) -> [u32; 4] {
    macro_rules! round4 {
        ( $a:ident, $b:ident, $c:ident, $d:ident, $k:expr, $s:expr, $i:expr ) => {
            $a = $b.wrapping_add(
...
fn compute_md5_digest(mut v: Vec<u8>) -> (u32, u32, u32, u32) {
    ...
    for chunk in v.chunks_exact_mut(64) {
        ...
        // execute round 1
        let result = round_one_operations(word_a, word_b, word_c, word_d, &x);
        word_a = result[0];
        word_b = result[1];
        word_c = result[2];
        word_d = result[3];
        ...
        // execute round 2
        let result = round_two_operations(word_a, word_b, word_c, word_d, &x);
        ...
        // execute round 3
        let result = round_three_operations(word_a, word_b, word_c, word_d, &x);
        word_a = result[0];
        word_b = result[1];
        word_c = result[2];
        word_d = result[3];
        ...
        // execute round 4
        let result = round_four_operations(word_a, word_b, word_c, word_d, &x);
        word_a = result[0];
        word_b = result[1];
        word_c = result[2];
        word_d = result[3];
